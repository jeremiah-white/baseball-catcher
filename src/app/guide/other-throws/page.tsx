...
export default function OtherThrowsPage() {
  return (
    <>
      ...
      <h4>Throwing to the Pitcher Covering Home</h4>
      <p>
      ...
      <h4>Throwing After a Swinging Strike Three</h4>
      <p>
