...
export default function BullpensPage() {
  return (
    <>
      ...
      <h4>Take advantage of your time in the pen.</h4>
      <p>
      ...
      <h4>Do not set up down the middle.</h4>
      <p>
      ...
      <h4>Pay attention to what the pitchers are throwing.</h4>
      <p>
      ...
      <h4>Work on receiving and framing pitches.</h4>
      <p>
      ...
      <h4>Work on Sticking Strikes.</h4>
      <p>
