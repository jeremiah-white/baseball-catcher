...
export const metadata: Metadata = {
  title: "Catchers Miscellaneous Situations and Plays",
  description: "The catchers guide discusses miscellaneous plays and situations that a catcher may have to deal with through the course of a game.",
  keywords: ["baseball", "catcher", "catching", "run down", "bunt coverage", "squeeze play", "pick off", "pass ball", "wild pitch", "pop ups", "double steal", "dropped third strike", "intentional walk", "stealing home"],
};

export default function MiscPage() {
  return (
    <>
      <h1 className="page-header">Catchers Misc. Situations and Plays</h1>
      ...
      <p>
        <a href="#pace">Game Pace</a> | <a href="#buntsCoverage">Bunts/Coverage</a> | <a href="#squeezePlays">Squeeze Plays</a> | <a href="#runDowns">Run Downs</a> | <a href="#pickOffs">Pick Offs</a><br />
      ...
      <p>
        Be ready to react to a poorly bunted ball in front of the plate. You may be able to get the lead runner if you&apos;re quick. If you feel the play will be too close, take the out at first. Stay out of the big inning. Remember to clear the runner before throwing to first. *See the section on <Link href="/guide/throwing">throwing</Link> for more info.
      </p>
      ...
      <ul>
        <li>Never run a player toward the next base. Always force him back to the base he came from.</li>
        <li>Stand to your teammate&apos;s throwing side and never directly behind the runner. This provides a clear throwing lane.</li>
        <li>If your teammate running at you is right handed, stand to the left of the runner, so your teammate doesn&apos;t have to throw across the runner.</li>
        <li>As the runner approaches, use a one word verbal command like &quot;now&quot; and step toward the runner as you say it. Your momentum should be moving toward the runner as you say the command.</li>
        <li>The ball should be delivered by your teammate on that command.</li>
        <li>Catch the ball with both hands and immediately remove the ball with your bare hand.</li>
        <li>Show the ball above your head and run at the runner. The ball should be in a position where you can throw it at a moments notice.</li>
        <li>Stay to the right side so you have a clear throwing lane if you need to make another throw.</li>
        <li>DO NOT pump fake. Many times this will fake out your teammates as well.</li>
        <li>Run hard at the runner and apply the tag or wait for a &quot;now&quot; command from your teammate.</li>
        <li>Give up the ball when you hear the command. Throw the ball to your teammates chest.</li>
        <li>Peel off out of the baseline. This way you will not interfere with the runner.</li>
        <li>Be in position at the other bag if the rundown continues.</li>
      </ul>
      ...
      <p>
        Your main options as a catcher:<br />
      </p>
      <ul>
        <li>Hold the ball and allow the runner to reach second.</li>
        <li>Throw through to second to get that runner.</li>
        <li>Fake to second and throw to third.</li>
        <li>Throw to third.</li>
